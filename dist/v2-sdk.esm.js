...
var _FACTORY_ADDRESS_MAP, _INIT_CODE_HASH_MAP, _TRADE_FEE_MAP;
/**
 * @deprecated use FACTORY_ADDRESS_MAP instead
 */

var FACTORY_ADDRESS = '0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f';
var FACTORY_ADDRESS_MAP = (_FACTORY_ADDRESS_MAP = {}, _FACTORY_ADDRESS_MAP[ChainId.MAINNET] = '0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f', _FACTORY_ADDRESS_MAP[ChainId.GOERLI] = '0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f', _FACTORY_ADDRESS_MAP[ChainId.SEPOLIA] = '0xB7f907f7A9eBC822a80BD25E224be42Ce0A698A0', _FACTORY_ADDRESS_MAP[ChainId.OPTIMISM] = '0x0c3c1c532F1e39EdF36BE9Fe0bE1410313E074Bf', _FACTORY_ADDRESS_MAP[ChainId.ARBITRUM_ONE] = '0xf1D7CC64Fb4452F05c498126312eBE29f30Fbcf9', _FACTORY_ADDRESS_MAP[ChainId.AVALANCHE] = '0x9e5A52f57b3038F1B8EeE45F28b3C1967e22799C', _FACTORY_ADDRESS_MAP[ChainId.BASE] = '0x8909dc15e40173ff4699343b6eb8132c65e18ec6', _FACTORY_ADDRESS_MAP[ChainId.BNB] = '0x8909Dc15e40173Ff4699343b6eB8132c65e18eC6', _FACTORY_ADDRESS_MAP[ChainId.POLYGON] = '0x9e5A52f57b3038F1B8EeE45F28b3C1967e22799C', _FACTORY_ADDRESS_MAP[ChainId.CELO] = '0x79a530c8e2fA8748B7B40dd3629C0520c2cCf03f', _FACTORY_ADDRESS_MAP[ChainId.BLAST] = '0x5C346464d33F90bABaf70dB6388507CC889C1070', _FACTORY_ADDRESS_MAP[ChainId.BEVM] = '0xAdEFa8CFD0655e319559c482c1443Cc6fa804C1F', _FACTORY_ADDRESS_MAP[ChainId.BEVM_CANARY_TESTNET] = '0x1045D426488B359592864D3BDC3a64ebEBcDdf96', _FACTORY_ADDRESS_MAP[ChainId.BITLAYER_TESTNET] = '0x57e0e352a82928a28ce453d9a9fa005a9922aa49', _FACTORY_ADDRESS_MAP);
/**
 * default from uniswap
 */

var INIT_CODE_HASH = '0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f';
var INIT_CODE_HASH_MAP = (_INIT_CODE_HASH_MAP = {}, _INIT_CODE_HASH_MAP[ChainId.BEVM] = '0xa1d96c4e569a8fba6c4ad8d633250547339e9fb98e185d256480ed16c528c9e2', _INIT_CODE_HASH_MAP[ChainId.BEVM_CANARY_TESTNET] = '0xa1d96c4e569a8fba6c4ad8d633250547339e9fb98e185d256480ed16c528c9e2', _INIT_CODE_HASH_MAP[ChainId.BITLAYER_TESTNET] = '0xa1d96c4e569a8fba6c4ad8d633250547339e9fb98e185d256480ed16c528c9e2', _INIT_CODE_HASH_MAP);
var MINIMUM_LIQUIDITY = /*#__PURE__*/JSBI.BigInt(1000);
/**
 * default from uniswap
 */

var TRADE_FEE = /*#__PURE__*/JSBI.BigInt(9970); // 0.3%

var TRADE_FEE_MAP = (_TRADE_FEE_MAP = {}, _TRADE_FEE_MAP[ChainId.BEVM] = /*#__PURE__*/JSBI.BigInt(9960), _TRADE_FEE_MAP[ChainId.BEVM_CANARY_TESTNET] = /*#__PURE__*/JSBI.BigInt(9960), _TRADE_FEE_MAP[ChainId.BITLAYER_TESTNET] = /*#__PURE__*/JSBI.BigInt(9960), _TRADE_FEE_MAP); // exports for internal consumption
...
var Pair = /*#__PURE__*/function () {
  ...
  _proto.getOutputAmount = function getOutputAmount(inputAmount) {
    ...
    var inputAmountWithFee = JSBI.multiply(inputAmount.quotient, (_TRADE_FEE_MAP$inputA = TRADE_FEE_MAP[inputAmount.currency.chainId]) != null ? _TRADE_FEE_MAP$inputA : TRADE_FEE);
  ...
  _proto.getInputAmount = function getInputAmount(outputAmount) {
    ...
    var denominator = JSBI.multiply(JSBI.subtract(outputReserve.quotient, outputAmount.quotient), (_TRADE_FEE_MAP$output = TRADE_FEE_MAP[outputAmount.currency.chainId]) != null ? _TRADE_FEE_MAP$output : TRADE_FEE);
...
var Router = /*#__PURE__*/function () {
  ...
  Router.removeCallParameters = function removeCallParameters(pair, token0, token1, totalSupply, balance, decreasePercent, options) {
    ...
    var to = validateAndParseAddress(options.recipient);
    var slippageAdjusted = new Fraction(ONE).add(options.allowedSlippage).invert();
    var liquidity = new Fraction(balance).multiply(decreasePercent).divide(100);
